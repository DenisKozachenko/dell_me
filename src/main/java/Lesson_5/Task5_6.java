...
public class Task5_6 {
    ...
    public static void main(String... arg) {
        ...
        String largestString = task.findLargestString(lst);
        largestStringArray = task.findDuplicates(lst, largestString);
        task.printList(largestStringArray);
    }

    private  String findLargestString(List<String> list) {
        int index = 0;
        int larg = 0;
    ...
    private List<String> findDuplicates(List<String> list, String value) {
